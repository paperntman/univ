...
export let curriculumAreasFromApi: ApiSubjectInfo[] = []; // API에서 가져온 교과 영역 목록
export function setCurriculumAreasFromApi(areas: ApiSubjectInfo[]) { // 교과 영역 목록 설정
    curriculumAreasFromApi = areas;
}
